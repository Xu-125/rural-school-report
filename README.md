...
<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@300;400;500;700;900&family=Noto+Sans+SC:wght@300;400;500;700&family=Cormorant+Garamond:wght@300;400;600&display=swap" rel="stylesheet">
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  :root{
    ...
    --muted:#5a6b5a;
    --line:#bccab1;
    --accent:#3d6b4a;       /* deep forest green */
    --accent-2:#5a8c5a;     /* mid green */
    --leaf:#7ba05b;         /* leaf green */
    --gold:#a8b85a;         /* yellow green */
    --moss:#4a6b3a;
  }
  ...
  @keyframes floatLeaf{
    ...
    50%{transform:translate(80px,20px) rotate(180deg);}
  ...
  .hero .meta{
    ...
    margin-bottom:40px; font-family:'Noto Sans SC', sans-serif;
    opacity:0;
  ...
  .hero .scroll{
    ...
    z-index:2;
    opacity:0;
    animation:fadeUp 1s 1.6s forwards, bounce 2s 2.6s infinite;
  }
  @keyframes bounce{
  ...
  .stage:hover .stage-num .big{color:var(--accent);}
  .stage-num .years{
    display:block;
    color:var(--muted);
    font-size:13px;
  ...
  .stage-data .data-desc{
    font-size:13px; color:var(--ink);
    margin-bottom:18px;
    line-height:1.7;
  }
  .stage-data .data-bar{
    height:6px; background:#d4d8c0; border-radius:3px;
  ...
  .kid-section h3{
    ...
    color:#f4f5ee;
    font-weight:500;
    border-bottom:1px solid rgba(168,184,90,0.2);
    padding-bottom:14px;
  }
  .kid-grid{
    display:grid;
  ...
  .kid-card:hover{
    background:rgba(168,184,90,0.08);
  ...
  .stat-item .stat-label{
    font-size:12px; color:#b8c5a8;
    letter-spacing:3px; margin-top:10px;
    font-family:'Noto Sans SC', sans-serif;
  }

  /* ===== VOICES (S7) - Expandable ===== */
...
<nav>
  <div class="brand">乡村教育观察 · RURAL EDUCATION</div>
  <ul>
...
<header class="hero">
  ...
  <div class="hero-content">
    <div class="meta">DEEP REPORT · <span>2026 / 乡村教育专题</span></div>
  ...
  <div class="timeline">
    ...
    <div class="stage reveal">
      <div class="stage-num">
        ...
        <span class="years">1980s — 2000<br>初步萌芽</span>
      </div>
      ...
      <div class="stage-data" style="--w:100%">
        <div class="data-label">FOUNDATIONAL DATA</div>
    ...
    <div class="stage reveal">
      <div class="stage-num">
        ...
        <span class="years">2001 — 2005<br>成型提速</span>
      </div>
      <div class="stage-content">
        <h3>自上而下的强力推进</h3>
      ...
      <div class="stage-data" style="--w:80%">
        <div class="data-label">RAPID DECLINE</div>
    ...
    <div class="stage reveal">
      <div class="stage-num">
        ...
        <span class="years">2006 — 2012<br>变形纠偏</span>
      </div>
      <div class="stage-content">
        <h3>紧急刹车与制度补救</h3>
      ...
      <div class="stage-data" style="--w:30%">
        <div class="data-label">EMERGENCY BRAKE</div>
    ...
    <div class="stage reveal">
      <div class="stage-num">
        ...
        <span class="years">2013 — 2026<br>稳慎优化</span>
      </div>
      <div class="stage-content">
        <h3>从"能撤尽撤"到"应留必留"</h3>
...
<div class="case" id="shaanxi">
  <div class="case-hero shaanxi">
    <div class="place reveal">陕西 · SHAANXI</div>
    <h2 class="reveal reveal-delay-1">一代人的<br>求学迁徙</h2>
    <p class="case-sub reveal reveal-delay-2">兴平·丰仪·策村——被时间与生源慢慢掏空的村小</p>
  </div>
  <div class="case-body">
    ...
    <div class="school-grid">
      ...
      <div class="school-card reveal reveal-delay-1">
      ...
      <div class="school-card reveal reveal-delay-2">
...
<div class="case" id="hunan">
  <div class="case-hero hunan">
    <div class="place reveal">湖南 · HUNAN</div>
    <h2 class="reveal reveal-delay-1">群山褶皱里<br>告别最后一学期</h2>
    <p class="case-sub reveal reveal-delay-2">娄底·云山——所有人都知道：这是最后一程</p>
  </div>
  <div class="case-body">
    ...
    <div class="kid-section">
      ...
      <div class="kid-grid">
        <div class="kid-card reveal">
          <div class="kid-name">曾湘欧</div>
          <p>母亲离家，父亲打工，爷爷疏于看管。曾喝墨水、爬栏杆，情绪冲动缺乏引导。</p>
        </div>
        <div class="kid-card reveal reveal-delay-1">
          <div class="kid-name">曾皓轩</div>
          <p>父母离异，经历"家暴"，因为母亲吃回吐出的东西而患胃病。</p>
        </div>
        <div class="kid-card reveal reveal-delay-2">
          <div class="kid-name">廖雨辰</div>
          <p>家庭关系复杂，常年住校跟校长生活，自理早熟，像小大人一样处理班级矛盾。</p>
        </div>
        <div class="kid-card reveal reveal-delay-3">
          <div class="kid-name">曾景桐</div>
          <p>脑瘫学生，学校每月上门两次提供教学，守住义务教育底线。</p>
        </div>
      </div>
    </div>
...
<section id="scholars">
  <div class="reveal"><div class="section-tag">CHAPTER 03 · 学者视角</div></div>
  <h2 class="section-title reveal">不只是<br>"撤"或"留"</h2>
...
<footer>
  ...
  <div class="credits">
    乡村教育深度报道 · 2026 / DESIGNED WITH RESPECT TO RURAL CHINA
  </div>
</footer>

<script>
/* ===== Voices data & rendering ===== */
const voices = [
...
voices.forEach((v,i)=>{
  ...
  card.innerHTML = `
    ...
    <div class="v-expand">
      ${v.quote.map(q=>`<p>"${q}"</p>`).join('')}
    </div>
    <div class="v-toggle"><span class="icon">+</span> <span class="txt">展开完整语录</span></div>
  `;
  card.addEventListener('click', ()=>{
    const isOpen = card.classList.contains('expanded');
    // close others (optional - allow multiple open)
    // document.querySelectorAll('.voice-card.expanded').forEach(c=>c.classList.remove('expanded'));
